const CACHE='genevieve-health-irene-safety-v3';
const ASSETS=['./','./index.html','./styles.css','./core.js','./app.js','./manifest.webmanifest','./privacy.html','./safety.html','./terms.html','./assets/genevieve-ga-logo-approved-original.png','./assets/genevieve-tree-logo-approved-original.jpeg','./assets/icon-192.png','./assets/icon-512.png'];
